        ...
        <View style={s.section}>
          <View style={s.card}>
            {[ 
              ...
              { t: t('welcome') === 'Welcome' ? 'Mark Milestones' : 'Milestone'ları İşaretle', d: t('welcome') === 'Welcome' ? 'Percentage automatically increases as you complete subtasks within goals.' : 'Hedef içindeki alt görevleri tamamladıkça yüzde otomatik artar.' },
